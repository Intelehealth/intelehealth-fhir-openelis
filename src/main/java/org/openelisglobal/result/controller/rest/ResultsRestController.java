...
public class ResultsRestController extends LogbookResultsBaseController {
    ...
    @Autowired
    private FhirApiWorkflowService fhirApiWorkFlowServiceImpl;
    ...
    public AccessionResultsForm getResults(@RequestParam String labNumber)
    	...
    	System.err.println("fhirApiWorkFlowServiceImpl::"+fhirApiWorkFlowServiceImpl);
    	fhirApiWorkFlowServiceImpl.pollForRemoteTasks();
        // return
